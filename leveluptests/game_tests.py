...
class GameTests(APITestCase):
    ...
    def test_create_game(self):
        ...
        self.assertEqual(json_response["difficulty"], "hard")
        self.assertEqual(json_response["min_players"], 6)
        self.assertEqual(json_response["max_players"], 12)
    ...
    def test_get_game(self):
        ...
        self.assertEqual(json_response["difficulty"], "hard")
        self.assertEqual(json_response["min_players"], 4)
    ...
    def test_change_game(self):
        ...
        self.assertEqual(json_response["difficulty"], "easy")
        self.assertEqual(json_response["min_players"], 4)
        self.assertEqual(json_response["max_players"], 8)
        self.assertEqual(json_response["game_type"]["id"], 1)
